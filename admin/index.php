...
<div class="overview-content">
    ...
    <div class="overview-wrap">
        <div class="overview-number"><?php echo $forum->count(); ?></div>
...
<div class="overview-content">
    ...
    <div class="overview-wrap">
        <div class="overview-number"><?php echo $topic->count(); ?></div>
...
<div class="overview-content">
    ...
    <div class="overview-wrap">
        <div class="overview-number"><?php echo $reply->count(); ?></div>
...
<div class="overview-content">
    ...
    <div class="overview-wrap">
        <div class="overview-number"><?php echo $user->count(); ?></div>
